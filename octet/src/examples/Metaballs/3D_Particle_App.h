...
*/
      ...
      cameraToWorld.translate(0, 0.1f, 3);
...
void check_state(sim_state_t* s)
{
  ...
  //}
	...
	float cube_verts[] = {
		...
		vec4 color1(1, 1, 1, 1);
      color_shader_.render(modelToProjection, color1.get());
	  glVertexAttribPointer(attribute_pos, 3, GL_FLOAT, GL_FALSE, 3*sizeof(float), (void*)cube_verts);
